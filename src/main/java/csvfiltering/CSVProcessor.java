...
public class CSVProcessor {
	...
	public static void filterOnPeriod(String startDateTime, String endDateTime) throws ParseException {
		...
		String xdlu_folder_out = "./files/CSV/Audun/_FILTER_PERIOD/xdlu_split_filtered";
		String loadingUnitIdFile = "./files/CSV/Audun/_FILTER_PERIOD/relevant_loading_unit_ids/loadingUnitIds.txt"; 
		String consignmentIdFile = "./files/CSV/Audun/_FILTER_PERIOD/relevant_consignment_ids/consignmentIds.txt"; 
		String waveIdFile = "./files/CSV/Audun/_FILTER_PERIOD/relevant_wave_ids/waveIds.txt"; 
		String shipmentIdFile = "./files/CSV/Audun/_FILTER_PERIOD/relevant_shipment_ids/shipmentIds.txt";
		String transportIdFile = "./files/CSV/Audun/_FILTER_PERIOD/relevant_transport_ids/transportIds.txt";
		String consignments_folder_filtered = "./files/CSV/Audun/_FILTER_PERIOD/consignments_split_filtered";
		String loadingUnits_folder_filtered = "./files/CSV/Audun/_FILTER_PERIOD/loadingunits_split_filtered";
		String waves_folder_filtered = "./files/CSV/Audun/_FILTER_PERIOD/waves_split_filtered";
		String tradeItems_folder_filtered = "./files/CSV/Audun/_FILTER_PERIOD/tradeitems_split_filtered";
		String dgr_folder_filtered = "./files/CSV/Audun/_FILTER_PERIOD/drgs_split_filtered";
		String shipmentItems_folder_filtered = "./files/CSV/Audun/_FILTER_PERIOD/shipmentitems_split_filtered";
		String shipments_folder_filtered = "./files/CSV/Audun/_FILTER_PERIOD/shipments_split_filtered";
		String transports_folder_filtered = "./files/CSV/Audun/_FILTER_PERIOD/transports_split_filtered";
