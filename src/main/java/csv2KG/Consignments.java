		...
		for (int i = 0; i < filesInDir.length; i++) {
			...
			try {
				...
				for (String[] params : line) {
					...
					bw.write(RDF4JUtilities.createType(consignmentEntity, baseURI, rdf_type, type, tripleClosure));

					//includesTransport
					if (!params[3].equals("NULL")) {

						bw.write(RDF4JUtilities.createObjectProperty(consignmentEntity, baseURI, "includesTransport", params[3], "_transport", tripleClosure));
					}

					//processedByWave
					if (!params[18].equals("NULL")) {								

						bw.write(RDF4JUtilities.createObjectProperty(consignmentEntity, baseURI, "processedByWave", params[18], "_wave", tripleClosure));
					}

					//hasCarrierParty						
					bw.write(RDF4JUtilities.createObjectProperty(consignmentEntity, baseURI, "hasCarrierParty", params[11], "_party", tripleClosure));

					//hasConsignorParty						
					bw.write(RDF4JUtilities.createObjectProperty(consignmentEntity, baseURI, "hasConsignorParty", params[14], "_party", tripleClosure));

					//hasConsigneeParty					
					bw.write(RDF4JUtilities.createObjectProperty(consignmentEntity, baseURI, "hasConsigneeParty", params[17], "_party", tripleClosure));

					//taskClosedOn
					if (!StringUtilities.convertToDateTime(params[23]).equals("0000-00-00T00:00:00")) {

						bw.write(RDF4JUtilities.createDataProperty(consignmentEntity, baseURI, "taskClosedOn", StringUtilities.convertToDateTime(params[23]), DATATYPE_DATETIME, tripleClosure));
					}

					//consignmentId						
					bw.write(RDF4JUtilities.createDataProperty(consignmentEntity, baseURI, "consignmentId", params[0], DATATYPE_STRING, tripleClosure));
					
					//consignmentType						
					bw.write(RDF4JUtilities.createDataProperty(consignmentEntity, baseURI, "consignmentType", params[6], DATATYPE_STRING, tripleClosure));

					//fullPalletConsignment						
					bw.write(RDF4JUtilities.createDataProperty(consignmentEntity, baseURI, "fullPalletConsignment", params[32], DATATYPE_STRING, tripleClosure));

					//qttBoxes						
					bw.write(RDF4JUtilities.createDataProperty(consignmentEntity, baseURI, "qttBoxes", params[33], DATATYPE_INT, tripleClosure));

					//qttPallets						
					bw.write(RDF4JUtilities.createDataProperty(consignmentEntity, baseURI, "qttPallets", params[34], DATATYPE_INT, tripleClosure));

					//qttReconstructedPallets						
					bw.write(RDF4JUtilities.createDataProperty(consignmentEntity, baseURI, "qttReconstructedPallets", params[35], DATATYPE_INT, tripleClosure));

					//qttReconstructedParcels						
					bw.write(RDF4JUtilities.createDataProperty(consignmentEntity, baseURI, "qttReconstructedParcels", params[36], DATATYPE_INT, tripleClosure));

					//totalConsignmentVolume						
					bw.write(RDF4JUtilities.createDataProperty(consignmentEntity, baseURI, "totalConsignmentVolume", params[40], DATATYPE_DECIMAL, tripleClosure));

					//totalConsignmentWeight
					bw.write(RDF4JUtilities.createDataProperty(consignmentEntity, baseURI, "totalConsignmentWeight", params[41], DATATYPE_DECIMAL, tripleClosure));
